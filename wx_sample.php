	...
	private function handleEvent($postObj)
	{
		switch ($postObj->Event)
		{
			case "subscribe":
				...
				'picUrl' => 'http://clandy.comuf.com/wechat/main/bakerzin.jpg',
				'url' => ''
				);
		...
		if(!empty( $keyword ))
		{
			...
			switch( $keyword )
			{
				...
				case "Menu" :
					...
					'description' =>'null',
					'picUrl' => 'http://clandy.comuf.com/wechat/menu/menu-title.jpg',
					'url' => ''
					);
					$record[1]=array(
					'title' =>'B1. DESSERTS',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/menu/desserts.bmp',
					'url' =>''
					);
					$record[2]=array(
					'title' =>'B2. APPETISERS & STARTERS',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/menu/A&S.bmp',
					'url' => ''
					);
					$record[3]=array(
					'title' =>'B3. PASTA',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/menu/pasta.bmp',
					'url' => ''
					);
				...
				case "B1" :
					...
					'title' =>'DESSERTS',
					'description' =>'null',
					'picUrl' => 'http://clandy.comuf.com/wechat/desserts/desserts.bmp',
					'url' => ''
					);
					$record[1]=array(
					'title' =>'TIRAMISU',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/desserts/tiramisu.bmp',
					'url' =>'http://mp.weixin.qq.com/s?__biz=MzAwMzAyOTM0Mg==&mid=201296610&idx=2&sn=f8e95cae08a827951dbe59d2b6b13f23#rd'
					);
					$record[2]=array(
					'title' =>'ADAGIO',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/desserts/adagio.bmp',
					'url' =>'http://mp.weixin.qq.com/s?__biz=MzAwMzAyOTM0Mg==&mid=201296610&idx=3&sn=47fffcec06bffb15b90192ec958e88c6#rd'
					);
					$record[3]=array(
					'title' =>'OPERA',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/desserts/opera.bmp',
				...
				case "B2" :
					...
					'description' =>'null',
					'picUrl' => 'http://clandy.comuf.com/wechat/A&S/A&S.bmp',
					'url' => ''
					);
					$record[1]=array(
					'title' =>'BAKED CHICKEN WINGS',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/A&S/BCW.bmp',
					...
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/A&S/BPS.bmp',
					...
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/A&S/BPW.bmp',
				...
				case "B3" :
					...
					'title' =>'CARBONARA',
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/pasta/carbonara.bmp',
				...
				case "Q&a" :
					...
					'description' =>'',
					'picUrl' => 'http://clandy.comuf.com/wechat/T&C-title.jpg',
					'url' => ''
					);
					$record[1]=array(
				...
				case "Where" :
					...
					'picUrl' => 'http://clandy.comuf.com/wechat/staticmap.jpg',
				...
				default:
					...
					'picUrl' => 'http://clandy.comuf.com/wechat/main/about-us.jpg',
					'url' => ''
					);
					$record[2]=array(
					'title' =>'B. Menu',
					'description' =>'A Selectioon of Gourmet Delicates',
					'picUrl' => 'http://clandy.comuf.com/wechat/main/menu.jpg',
					'url' => ''
					);
					$record[3]=array(
					'title' =>'C. Terms & Conditions',
					'description' =>'DELIVERY CHARGES, AMENDMENTS AND CANCELLATION, DELIVERY INFORMATION',
					'picUrl' => 'http://clandy.comuf.com/wechat/main/T&C.jpg',
					'url' => ''
					);
					$resultStr = response_Multiplenews($postObj, $record);
					break;
